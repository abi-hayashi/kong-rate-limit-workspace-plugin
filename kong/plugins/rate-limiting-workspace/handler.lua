...
local policies = require "kong.plugins.rate-limiting-workspace.policies"
...
local RateLimitingWorkspaceHandler = {}


RateLimitingWorkspaceHandler.VERSION = kong_meta.version
RateLimitingWorkspaceHandler.PRIORITY = 910
...
function RateLimitingWorkspaceHandler:access(conf)
...
return RateLimitingWorkspaceHandler
